...
let precioTotal: number =
  precioDefinido1 + precioDefinido2 + precioDefinido3 + precioDefinido4;
...
console.log(
  `voy a comprar ${cantidad1} ${producto1}  ${cantidad2} ${producto2} ${cantidad3} ${producto3} ${cantidad4} ${producto4}`
);
console.log(
  `el precio de ${producto1} seria ${precioDefinido1} el precio de ${producto2} ${precioDefinido2} el precio de ${producto3} ${precioDefinido3} el precio de ${producto4} ${precioDefinido4}`
);
console.log(`el precio total seria ${precioTotal}`);
console.log(
  `el stock restante de cada producto seria ${producto1} ${stockRestante1} ${producto2} ${stockRestante2} ${producto3} ${stockRestante3} ${producto4} ${stockRestante4}`
);
